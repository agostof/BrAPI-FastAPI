...
class ExternalReferences(BaseModel):
    __root__: List[ExternalReference] = Field(
        ...,
...
class BreedingInstitute(BaseModel):
...
class CollectingInstitute(BaseModel):
...
class CollectingInfo(BaseModel):
    ...
    collectingInstitutes: Optional[List[CollectingInstitute]] = Field(
        None, description='Institutes which collected the sample'
    )
    ...
    collectingSite: Optional[CollectingSite] = Field(
        None,
        description='Information about the location where the sample was collected',
    )


class DonorInstitute(BaseModel):
    instituteCode: Optional[str] = Field(
        None,
...
class DonorInfo(BaseModel):
    ...
    donorInstitute: Optional[DonorInstitute] = None
...
class SafetyDuplicateInstitute(BaseModel):
    instituteCode: Optional[str] = Field(
        None,
...
class GermplasmMCPD(BaseModel):
    ...
    breedingInstitutes: Optional[List[BreedingInstitute]] = None
    collectingInfo: Optional[CollectingInfo] = Field(
        None, description='Information about the collection of this germplasm'
    )
    ...
    donorInfo: Optional[DonorInfo] = Field(
        None, description='Information about the donor'
    )
    ...
    safetyDuplicateInstitutes: Optional[List[SafetyDuplicateInstitute]] = None
...
class OntologyReference(BaseModel):
    documentationLinks: Optional[List[DocumentationLink]] = Field(
...
class PedigreeNode(BaseModel):
    ...
    siblings: Optional[List[Sibling]] = Field(
        None,
...
class ProgenyNode(BaseModel):
    ...
    progeny: List[ProgenyItem] = Field(
        ...,
...
class SeedLotNewTransactionRequest(BaseModel):
    ...
    transactionTimestamp: Optional[datetime] = Field(
        None, description='The time stamp for when the transaction occured'
    )
    units: Optional[str] = Field(
        None,
...
class CrossNewRequest(BaseModel):
    ...
    crossAttributes: Optional[List[CrossAttribute]] = Field(
...
class AttributesCategoriesGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result2


class AttributevaluesGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result3


class AttributevaluesPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result4


class AttributevaluesttributeValueDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: GermplasmAttributeValue


class AttributevaluesttributeValueDbIdPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: GermplasmAttributeValue


class BreedingmethodsGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result5


class BreedingmethodsreedingMethodDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
...
class CrossesGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result6
...
class CrossesPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result7
...
class CrossesPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result8
...
class CrossingprojectsGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result9
...
class CrossingprojectsPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result10


class CrossingprojectsrossingProjectDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: CrossingProject


class CrossingprojectsrossingProjectDbIdPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: CrossingProject


class GermplasmermplasmDbImcpdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: GermplasmMCPD


class GermplasmermplasmDbIpedigreeGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: PedigreeNode


class GermplasmermplasmDbIprogenyGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: ProgenyNode


class PlannedcrossesGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result13


class PlannedcrossesPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result14


class PlannedcrossesPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result15


class SearchAttributesPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result16] = None


class SearchAttributesearchResultsDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result17] = None


class SearchAttributevaluesPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result18] = None


class SearchAttributevaluesearchResultsDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result19] = None


class SearchGermplasmPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result20] = None


class SearchGermplasmearchResultsDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result21] = None


class SeedlotsGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result22


class SeedlotsPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result23


class SeedlotsTransactionsGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result24


class SeedlotsTransactionsPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result25


class SeedlotseedLotDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: SeedLot


class SeedlotseedLotDbIdPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: SeedLot


class SeedlotseedLotDbItransactionsGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result26
...
class AttributesGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result
...
class AttributesPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result1


class AttributesttributeDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: GermplasmAttribute


class AttributesttributeDbIdPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: GermplasmAttribute
...
class GermplasmNewRequest(BaseModel):
    ...
    donors: Optional[List[Donor]] = Field(None, description='List of donor institutes')
    externalReferences: Optional[ExternalReferences] = None
    genus: Optional[str] = Field(
        None,
    ...
    storageTypes: Optional[List[StorageType]] = Field(
        None,
...
class GermplasmGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result11
...
class GermplasmPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result12


class GermplasmermplasmDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Germplasm


class GermplasmermplasmDbIdPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Germplasm
