...
class Event(BaseModel):
    ...
    eventParameters: Optional[List[EventParameter]] = Field(
        None,
        ...
        example=[
            ...
            {'key': 'fertilizer', 'value': 'nitrogen', 'valueRdfType': None},
        ],
    )
    eventType: str = Field(
        ...,
...
class ObservationVariable1(BaseModel):
...
class ObservationTable(BaseModel):
    ...
    observationVariables: Optional[List[ObservationVariable1]] = Field(
        None,
...
class ObservationLevel(ObservationUnitLevelRelationship):
    pass
...
class ObservationVariable2(BaseModel):
    observationVariableDbId: Optional[str] = Field(
        None, description='Variable unique identifier', example='367aa1a9'
    )
    observationVariableName: Optional[str] = Field(
...
class ObservationUnitTable(BaseModel):
    ...
    observationVariables: Optional[List[ObservationVariable2]] = Field(
        None,
        description="The list of observation variables which have values recorded for them in the data matrix. Append to the 'headerRow' for complete header row of the table.",
        example=[
            {
...
class MethodsGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result3
...
class MethodsPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result4


class MethodsethodDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Method


class MethodsethodDbIdPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Method


class ObservationlevelsGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result5
...
class ObservationsGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result6
...
class ObservationsPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result7
...
class ObservationsPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result8


class ObservationsTableGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: ObservationTable


class ObservationsbservationDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Observation


class ObservationsbservationDbIdPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Observation


class ObservationunitsTableGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: ObservationUnitTable


class OntologiesGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result12
...
class ScalesGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result13
...
class ScalesPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result14


class ScalescaleDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Scale


class ScalescaleDbIdPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Scale


class SearchImagesPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result15] = None


class SearchImagesearchResultsDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result16] = None


class SearchObservationsPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result17] = None


class SearchObservationsearchResultsDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result18] = None


class SearchObservationunitsPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result19] = None


class SearchObservationunitsearchResultsDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result20] = None


class SearchVariablesPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result21] = None


class SearchVariablesearchResultsDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Optional[Metadata] = None
    result: Optional[Result22] = None


class TraitsGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result23


class TraitsPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result24


class TraitsraitDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Trait


class TraitsraitDbIdPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Trait
...
class VariablesGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result25
...
class VariablesPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result26


class VariablesbservationVariableDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: ObservationVariable


class VariablesbservationVariableDbIdPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: ObservationVariable
...
class ObservationUnitPosition(BaseModel):
    ...
    observationLevel: Optional[ObservationLevel] = None
    observationLevelRelationships: Optional[
        List[ObservationUnitLevelRelationship]
    ] = Field(
        None,
...
class ImagesmageDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Image


class ImagesmageDbIdPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Image


class ImagesmageDbIimagecontentPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Image
...
class ObservationunitsGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result9
...
class ObservationunitsPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result10
...
class ObservationunitsPostResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: Result11


class ObservationunitsbservationUnitDbIdGetResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: ObservationUnit


class ObservationunitsbservationUnitDbIdPutResponse(BaseModel):
    _context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: ObservationUnit
